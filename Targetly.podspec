#
#  Be sure to run `pod spec lint Targetly.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "Targetly"
  spec.version      = "0.1.0"
  spec.summary      = "Targetly is personalising the Notifications."
  ...
  spec.author             = { "Otto Alex" => "otto92.alex@gmail.com" }
  # Or just: spec.author    = "Otto Alex"
  # spec.authors            = { "Otto Alex" => "otto92.alex@gmail.com" }
